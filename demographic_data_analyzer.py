...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = ((df[df['salary'] == '>50K']['education'].isin(['Bachelors', 'Masters', 'Doctorate']).sum() / higher_education) * 100).round(1)
    lower_education_rich = ((df[df['salary'] == '>50K']['education'].isin(['Bachelors', 'Masters', 'Doctorate']).eq(False).sum() / lower_education) * 100).round(1)
